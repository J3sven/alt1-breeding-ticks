...
//latest release int
a1lib.newestversionint = 1005005;
a1lib.newestversion = "1.5.5";
...
a1lib.hslitenames = ["totra", "totlv", "totxp", "attra", "-----", "attxp", "defra", "-----", "defxp", "strra", "-----", "strxp", "hpxra", "-----", "hpxxp", "ranra", "-----", "ranxp", "prara", "-----", "praxp", "magra", "-----", "magxp", "coora", "-----", "cooxp", "woora", "-----", "wooxp", "flera", "-----", "flexp", "fisra", "-----", "fisxp", "firra", "-----", "firxp", "crara", "-----", "craxp", "smira", "-----", "smixp", "minra", "-----", "minxp", "herra", "-----", "herxp", "agira", "-----", "agixp", "thira", "-----", "thixp", "slara", "-----", "slaxp", "farra", "-----", "farxp", "runra", "-----", "runxp", "hunra", "-----", "hunxp", "conra", "-----", "conxp", "sumra", "-----", "sumxp", "dunra", "-----", "dunxp", "divra", "-----", "divxp", "invra", "-----", "invxp", "arcra", "-----", "arcxp", "-----", "-----", "-----", "-----", "domra", "domsc", "crura", "crusc", "casra", "cassc", "baara", "baasc", "badra", "badsc", "bacra", "bacsc", "bahra", "bahsc", "-----", "-----", "mobra", "mobsc", "cnqra", "cnqsc", "fogra", "fogsc", "-----", "-----", "-----", "-----", "-----", "-----", "-----", "-----", "-----", "-----", "-----", "-----", "-----", "-----", "-----", "-----"];
...
a1lib.getregion = function (x, y, w, h) {
	...
	if (alt1.capture) {
		return new ImageData(alt1.capture(x, y, w, h), w, h);
	}
...
a1lib.bindgetregion = function (handle, x, y, w, h) {
	...
	if (alt1.bindGetRegionBuffer) {
		let r = new ImageData(alt1.bindGetRegionBuffer(handle, x, y, w, h), w, h);
		r.x = x;
		r.y = y;
		return r;
	}
...
a1lib.alt1imgdecode = function (str, r, x, y, w, h) {
	...
	var rwidth = r.width | 0;
	for (var a = 0; a < w; a++) {
		for (var b = 0; b < h; b++) {
			var i1 = (offset + (a * 4 | 0) + (b * rwidth * 4 | 0)) | 0;
